"""Unchanged from modules/pipe_hdb/helper_hdb.py.

Pure requests + polars, no filesystem or cloud-specific code in here, so nothing
about running on Databricks required touching this file at all - it's copied over
byte-for-byte on purpose. That's the payoff of the original pipeline keeping I/O
concerns out of its helpers.
"""
