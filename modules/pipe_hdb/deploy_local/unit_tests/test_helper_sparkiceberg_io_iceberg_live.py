...
def test_basic_round_trip(spark, data_narrow):
    from lakehouse_io.helper_sparkiceberg_io import write_partition_guarded
...
class TestPyicebergProvisionsSparkWrites:
    ...
    def test_provision_via_pyiceberg_then_write_via_spark(self):
        ...
        from lakehouse_io.helper_pyiceberg_io import getOrCreate_catalog, createOrEvolve_table
        ...
        try:
            ...
            from lakehouse_io.helper_sparkiceberg_io import write_partition_guarded, _current_partition_columns
