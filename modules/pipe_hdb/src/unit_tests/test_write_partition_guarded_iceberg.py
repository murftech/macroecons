...
from helper_pyiceberg_io import getOrCreate_catalog, createOrEvolve_table, write_partition_guarded
...
# the DRY pass (shared_schema_guards.py) unified vocabulary and check numbering
